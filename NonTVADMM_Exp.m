  function [U,PSNR,SNR,SSIM,i,f,t] = NonTVADMM_Exp(I,F,H,maxit,mu,s,beta1,beta2,rho,gamma)
...
for i = 1 : maxit
     ...
     Exp_c = 1/s;
     X = max(abs(KUF + Lam1/beta1) - (mu*Exp_c)/beta1, 0).*sign(KUF + Lam1/beta1);
