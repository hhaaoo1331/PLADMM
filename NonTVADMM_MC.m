function [U,PSNR,SNR,SSIM,i,f,t] = NonTVADMM_MC(I,F,H,maxit,mu,s,beta1,beta2,rho,gamma)
...
for i = 1 : maxit
     ...
     MC_c = 1;
     X = max(abs(KUF + Lam1/beta1) - (mu*MC_c)/beta1, 0).*sign(KUF + Lam1/beta1);
