function [U,PSNR,SNR,SSIM,i,f,t] = NonTVADMM_Fraction(I,F,H,maxit,mu,s,beta1,beta2,rho,gamma)
...
for i = 1 : maxit
     ...
     Fraction_c = s;
     X = max(abs(KUF + Lam1/beta1) - (mu*Fraction_c)/beta1, 0).*sign(KUF + Lam1/beta1);
