  function [U,PSNR,SNR,SSIM,i,f,t] = NonTVADMM_ET(I,F,H,maxit,mu,s,beta1,beta2,rho,gamma)
...
for i = 1 : maxit
     ...
     ET_c = s/(1-exp(-s));
     X = max(abs(KUF + Lam1/beta1) - (mu*ET_c)/beta1, 0).*sign(KUF + Lam1/beta1);
