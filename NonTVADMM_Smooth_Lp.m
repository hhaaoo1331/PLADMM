function [U,PSNR,SNR,SSIM,i,f,t] = NonTVADMM_Smooth_Lp(I,F,H,maxit,mu,s,r,beta1,beta2,rho,gamma)
...
for i = 1 : maxit
     ...
     Smooth_Lp_c = s*r^(s-1);
     X = max(abs(KUF + Lam1/beta1) - (mu*Smooth_Lp_c)/beta1, 0).*sign(KUF + Lam1/beta1);
...
function [D,Dt] = defDDt
 ...
 function [f] = fval(D1U,D2U,KUF,s,r,mu)
